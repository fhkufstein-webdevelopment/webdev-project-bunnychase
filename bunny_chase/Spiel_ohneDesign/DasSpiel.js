...
window.onkeydown = function(e) {
    ...
    if (keyboardEvent === 37 && leftHase-10>=leftCan) {
        if (hase.getAttribute('src') === "Bunnz-chace.png") {
            hase.setAttribute("src", "Hase-korb-links.png");
        }
        hase.style.left = leftHase-10 +'px';
    } else if (keyboardEvent === 39 && rightHase+10<=rightCan) {
        if (hase.getAttribute('src') === "Hase-korb-links.png") {
            hase.setAttribute("src", "Bunnz-chace.png");
        }
        hase.style.left = leftHase+10+'px';
    }
};
...
function component(width, height, x, y) {
    ...
    this.hitBottom = function (piece) {
        ...
        if ((this.y + this.height)>= bottom) {
            ...
            if (life<=0) {
                myGameArea.stop();
                alert("Sie haben keine Leben mehr!");
    ...
    this.hitCorb = function() {
        ...
        } else if (hase.getAttribute('src') === "Hase-korb-links.png") {
