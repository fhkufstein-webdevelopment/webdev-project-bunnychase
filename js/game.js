...
function component(width, height, x, y) {
    ...
    this.update = function() {
        ...
        if (ran === 1) {
            img.setAttribute("src", "js/Bilder/easter-egg.png");
        } else if (ran === 2) {
            img.setAttribute("src", "js/Bilder/Egg1.png");
        } else if (ran === 3) {
            img.setAttribute("src", "js/Bilder/Egg2.png");
        } else if (ran === 4) {
    ...
    this.hitCorb = function() {
        ...
        } else if (hase.getAttribute("src") === "js/Bilder/Hase-korb-links.png") {
...
function createCarrot(width, height, x, y) {
    ...
    this.update = function() {
        ...
        ctx.translate(this.x, this.y);
        var img = document.createElement("img");
        img.setAttribute("src", "js/Bilder/carrot.png");
        ctx.drawImage(img, 0,0, this.width, this.height);
        ctx.restore();
    };
